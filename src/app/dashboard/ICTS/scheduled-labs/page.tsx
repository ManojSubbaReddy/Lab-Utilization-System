            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {sessions.map((session) => (
                ...
                >
                  ...
                  <CardContent>
                    {/* <p>
                      <strong>Lab:</strong> {session.lab.name}
                    </p> */}
                    {/* <p>
                      <strong>Bookie Name:</strong> {session.bookedBy.userId}
                    </p> */}
                    {/* <p>
                      <strong>Bookie Name:</strong>{" "}
                      {session.bookedBy && session.bookedBy.userId
                        ? session.bookedBy._id
                        : "null"}
                    </p> */}
